...
class ModelArguments:
    ...
    peft_method: str = field(
        default="control",
        metadata={
            "help": "Which PEFT method to use. Candidates are control, lora and dora"
        }
    )
...
class TrainingArguments(TrainingArguments):
    ...
    control_rank: int = field(default=16, metadata={"help": "Control rank r"})
    control_alpha: float = field(default=1, metadata={"help": "Control alpha parameter"})
    lora_dropout: float = field(
        default=0, metadata={"help": "dropout rate for LoRA modules"}
    )
    ...
    fp16: bool = field(default=True, metadata={"help": "use bfloat16"})
