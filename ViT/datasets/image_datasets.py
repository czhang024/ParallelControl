...
def build_image_dataset(args):
    ...
    elif os.path.basename(args.finetune).startswith('ViT'):
    ...
    if args.dataset == 'imagenet':
        ...
        dataset_train = Food101(os.path.join(args.data_path, 'food101-temp'), split='train', transform=transform_train)
        dataset_val = Food101(os.path.join(args.data_path, 'food101-temp'), split='test', transform=transform_val)
        nb_classes = 101
    else:
