...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for data_iter_step, batch in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        metric_logger.update(lr=optimizer.param_groups[0]['lr'])  #ZC: add this line
        ...
        if log_writer is not None and (data_iter_step + 1) % accum_iter == 0:
            ...
            # log_writer.add_scalar('lr', max_lr, epoch_1000x)  # ZC: change the following line
            log_writer.add_scalar('lr', optimizer.param_groups[0]['lr'], epoch_1000x)  #ZC: change the following line
